...
func (prt *peerResponseTracker) getPeerValue(p peer.ID) float64 {
	...
	inversePeerValue := baseInversePeerValue * baseInversePeerValue * baseInversePeerValue * baseInversePeerValue * baseInversePeerValue * baseInversePeerValue * baseInversePeerValue * baseInversePeerValue * baseInversePeerValue * baseInversePeerValue
